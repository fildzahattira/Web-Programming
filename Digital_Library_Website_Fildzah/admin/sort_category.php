...
<body>
    ...
    if(isset($_POST['sort'])) { 
            ...
            $read = "SELECT * FROM book  INNER JOIN category ON book.category_book = category.id_category INNER JOIN account ON account.id_acc = book.user WHERE  category_book = '$sorting'";
