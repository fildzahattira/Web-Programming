...
<head>
    ...
    <title>FormUpdateAlamat_driver_Fildzah</title>
</head>
<body>
    <form action = "UpdateAlamat_driver_transupn_Fildzah.php" method = "post">
            <fieldset>
                <legend><h1>UPDATE ALAMAT</h1></legend>
                    <p>
                    ...
                    <p>
                        <label for = "alamat">Enter the new Alamat :</label>
