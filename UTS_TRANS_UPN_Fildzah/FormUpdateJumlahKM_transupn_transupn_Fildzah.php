...
<head>
    ...
    <title>FormUpdateJumlahKM_transupn_Fildzah</title>
</head>
<body>
    <form action = "UpdateJumlahKM_transupn_transupn_Fildzah.php" method = "post">
            <fieldset>
                <legend><h1>UPDATE JUMLAH KM</h1></legend>
                    <p>
